...
#             WEST-AFRICA FOOD COMPOSITION TABLE, 2019                        # 
#                                                                             #   
#                                                                             #   
###############################################################################
...
##1) LOADING PACKAGES AND WEST-AFRICA FCT
...
wafct <- readxl::read_excel(here::here( 'data', 
                                        'INFOODS-WAFCT_2019.xlsx'), sheet = 5,
                            skip = 2) %>%
...
#rename variables according to fao tagname and code-conventions
...
#creating variable 'foodgroups' from original WAFCT
...
#Saving MAPS-type FCT output data
